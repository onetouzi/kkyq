 ...
 */
@Controller
@RequestMapping("/bussiness/type")
public class BookTypeController extends BaseController
{
    private String prefix = "bussiness/type";

    @Autowired
    private IBookTypeService bookTypeService;

    @RequiresPermissions("bussiness:type:view")
    @GetMapping()
    public String type()
    {
        return prefix + "/type";
     ...
     * 查询图书类型列表
     */
    @RequiresPermissions("bussiness:type:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出图书类型列表
     */
    @RequiresPermissions("bussiness:type:export")
     ...
     * 新增图书类型
     */
    @RequiresPermissions("bussiness:type:add")
    @GetMapping("/add")
    public String add()
    {
        return prefix + "/add";
     ...
     * 修改图书类型
     */
    @RequiresPermissions("bussiness:type:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除图书类型
     */
    @RequiresPermissions("bussiness:type:remove")
